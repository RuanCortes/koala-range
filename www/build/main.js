...
var PostsProvider = (function () {
    function PostsProvider(http) {
        this.http = http;
        this.apiUrl = 'https://localhost:8080/posts';
